...
var openbox = function () {
  ...
  document.getElementById("icon_start").style.backgroundColor =
    "rgba(97, 87, 87, 0.637)";
  tasskbarcolor = true;
  ...
  document.getElementById("icon_start").style.borderBottom =
...
face_recognition[0].addEventListener("dblclick", function () {
  ...
  document.getElementById("give_icon").src =
    "https://img.icons8.com/plasticine/22/000000/face-id.png";
...
resume[0].addEventListener("dblclick", function () {
  ...
  document.getElementById("give_icon").src =
    "https://img.icons8.com/fluent/22/000000/open-resume.png";
...
project[0].addEventListener("dblclick", function () {
  ...
  document.getElementById("give_icon").src =
    "https://img.icons8.com/fluent/22/000000/group-of-projects.png";
...
notepad[0].addEventListener("dblclick", function () {
  ...
  document.getElementById("give_icon").src =
    "https://img.icons8.com/cute-clipart/22/000000/copybook.png";
...
chrome[0].addEventListener("dblclick", function () {
  ...
  document.getElementById("give_icon").src =
    "https://img.icons8.com/doodle/22/000000/chrome.png";
...
close.addEventListener("click", function () {
  ...
  document.getElementById("icon_start").style.backgroundColor =
    "rgb(36, 33, 33)";
  document.getElementById("icon_start").style.border =
    "0px solid rgb(36, 33, 33)";
...
document.getElementById("menu_game").addEventListener("click", function () {
  ...
  document.getElementById("iframe").src =
    "https://manwindersingh1712.github.io/RGB-Game/";
  document.getElementById("give_icon").src =
    "https://img.icons8.com/nolan/22/controller.png";
...
document.getElementById("menu_todo").addEventListener("click", function () {
  openbox();
  document.getElementById("iframe").src =
    "https://manwindersingh1712.github.io/TO-DO/";
  document.getElementById("give_icon").src =
    "https://img.icons8.com/fluent/22/000000/todo-list.png";
